			...
			?>
				...
				<ol class="breadcrumb">
					...
					<li class="active">Merk : <?php echo $merknya->namamerk;?></li>
				</ol>
				<h2 class="main-heading2">
					Merk : <?php echo $merknya->namamerk;?>
				</h2>
				...
				<div class="product-filter">
					<div class="row">
						<div class="col-md-4">
							<div class="display">
								<a href="<?php echo base_url()."kategori/index/".$this->uri->segment(3)."/0";?>" >
									<i class="fa fa-th-list" title="List View"></i>
								</a>
								<a href="<?php echo base_url()."kategori2/index/".$this->uri->segment(3)."/0";?>" class="active">
...
<button type="button" class="btn btn-compare" onclick="location.href='<?php echo base_url()."produk/index/".$listmobil->kodemobil;?>'">
				...
				if(empty($daftarmobil))
					...
					$nmr .= "<li><a href=".base_url()."merk2/index/".$this->uri->segment(3)."/".$angka.">$i</a></li>";
					$angka = $angka + 3;
					}
